...
//        Boolean check_video_time = this.check_video_time(video_path, mp4folder_path + mp4_name);
    ...
    public static void main(String[] args) throws IOException {
        //ffmpeg的路径
        String ffmpeg_path = "D:\\develop\\soft\\ffmpeg\\ffmpeg.exe";//ffmpeg的安装位置
        //源avi视频的路径
        String video_path = "E:\\Videos\\05-配置文件详解.wmv";
        //转换后mp4文件的名称
        String mp4_name = "05-配置文件详解.mp4";
        //转换后mp4文件的路径
        String mp4_path = "E:\\Videos\\05-配置文件详解.mp4";
        //创建工具类对象
